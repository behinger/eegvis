...
plot_topobutter(EEG.data(:,:,[1]),EEG.times,EEG.chanlocs,'butterfly','no','individualcontour','yes','time',[-150 450]) 
set(gcf,'Position',[996,1270,1066, 68])
%% 
% I argue for another way to plot the same topoplots:

plot_topobutter(EEG.data(:,:,[1]),EEG.times,EEG.chanlocs,'butterfly','no','individualcontour','no','time',[-150 450]) 
set(gcf,'Position',[996,1270,1066, 68])
%% 
...
ax = plot_topobutter(EEG.data(:,:,[1]),EEG.times,EEG.chanlocs,'butterfly','no','contour','no','individualcolormap','yes','time',[-150 450]);
...
ax = plot_topobutter(EEG.data(:,:,[1]),EEG.times,EEG.chanlocs,'butterfly','no','individualcolormap','yes','individualcontour','yes','time',[-150 450]);
cellfun(@(x)colormap(x,gray(128)),ax.topo.topo{1}.image)
set(gcf,'Position',[996,1270,1066, 68]);delete(ax.topo.ax_colorbar{1})
%% 
...
ax = plot_topobutter(EEG.data(:,:,[1]),EEG.times,EEG.chanlocs,'butterfly','no','contour','no','time',[-150 450]);
cellfun(@(x)colormap(x,gray(128)),ax.topo.topo{1}.image)
set(gcf,'Position',[996,1270,1066, 68]);delete(ax.topo.ax_colorbar{1})
%% 
...
ax = plot_topobutter(EEG.data(:,:,[1]),EEG.times,EEG.chanlocs,'butterfly','no','individualcolormap','yes','individualcontour','no','time',[-150 450]);
cellfun(@(x)colormap(x,gray(128)),ax.topo.topo{1}.image)
set(gcf,'Position',[996,1270,1066, 68]);delete(ax.topo.ax_colorbar{1})
%% 
...
ax = plot_topobutter(EEG.data(:,:,[1]),EEG.times,EEG.chanlocs,'butterfly','no','individualcontour','yes','time',[-150 450]);
cellfun(@(x)colormap(x,gray(128)),ax.topo.topo{1}.image)
set(gcf,'Position',[996,1270,1066, 68]);delete(ax.topo.ax_colorbar{1})
%% 
...
ax = plot_topobutter(EEG.data(:,:,[1]),EEG.times,EEG.chanlocs,'butterfly','no','individualcontour','no','time',[-150 450]);
cellfun(@(x)colormap(x,gray(128)),ax.topo.topo{1}.image)
set(gcf,'Position',[996,1270,1066, 68]);delete(ax.topo.ax_colorbar{1})
